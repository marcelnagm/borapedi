...
class Restorant extends MyModel {
    ...
    public function getLogowidedarkAttribute() {
        return $this->getImge($this->getConfig('resto_wide_logo', null), '/default/restaurant_wide_dark.png', '_original.png');
    }
    ...
    public function fidelity_program() {
        $fi = $this->hasOne(\App\Models\FidelityProgram::class, 'restaurant_id', 'id')->first();
        if ($fi != null) {
            return $fi;
        } else {
            return null;
