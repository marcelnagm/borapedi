                ...
                <div class="card-body px-lg-5 py-lg-5">
                    ...
                    <form role="form" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="text-center">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-danger my-4">
...
<?php echo $__env->make('layouts.app', ['class' => 'bg'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/borapedi/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>