            ...
            <div class="modal-body p-0">
                <div class="card">
                    <div class="card-header bg-white text-center">
                        <img class="img-center" src="<?php echo e($restorant->icon); ?>" width="100px" height="100px"></img>
                        <h3 class="headihng mt-4"><?php echo e($restorant->name); ?> &nbsp;<?php if(count($restorant->ratings)): ?><span><i class="fa fa-star" style="color: #dc3545"></i> <strong><?php echo e(number_format($restorant->averageRating, 1, '.', ',')); ?> <span class="small">/ 5 (<?php echo e(count($restorant->ratings)); ?>)</strong></span></span><?php endif; ?></h3>
                        <h5 class="description"><?php echo e($restorant->description); ?></h5>
                            ...
                            <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="heading-small text-muted"><a href="tel://<?php echo e($restorant->phone); ?>"><?php echo e($restorant->phone); ?></a></p>
                                        <br/>
                                        <h6 class="heading-small">Whatsapp</h6>
                                        <p class="heading-small text-muted"><a href="https://wa.me/<?php echo e($restorant->whatsapp_phone); ?>"><?php echo e($restorant->whatsapp_phone); ?></a></p>
                                        <br/>
                            ...
                            <div class="tab-pane fade" id="tabs-icons-text-3" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
                                <div class="table-responsive">
                                            ...
                                            <table class="table align-items-center table-flush">
                                                <tr>
                                                    <td>Programa de Fidelidade - <?php echo e($item->restorant()->name); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Regras
                                                        <p>
                                                            <?php if($item->type_target == 0 ): ?>
                                                            Ao fazer <?php echo e($item->target_orders); ?> pedidos de pelo menos R$<?php echo e($item->target_value); ?>  você tem direito ao benefício.
                                                            <?php else: ?>
                                                            Ao fazer R$<?php echo e($item->target_value); ?> em compras no restaurante  você tem direito ao benefício. 
                                                            <?php endif; ?>       
                                                        </p>
                                                    </td>
                                                </tr>
                                                <td>Beneficio:
                                                    ...
                                                    <p>
                                                        <?php if($item->type_reward == 0): ?>
                                                        Cupom de <?php echo e($item->type_coupon == 0 ? $item->reward." ".config('settings.cashier_currency') : $item->reward." %"); ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        $buys = auth()->user()->BuysByRestaurant($item->restorant()->id, 1);
                                                        ?>
                                                                    <?php echo e($buys['cont']); ?> Feitos / <?php echo e($item->target_orders); ?> Necessãrios 
                                                        ...
                                                        ?>
                                                                    ...
                                                                    R$<?php echo e($buys['total']); ?> Comprados / R$<?php echo e($item->target_value); ?> Necessãrios 
                                                                    <?php endif; ?>       
                                                                </div>

                                                            </div>
                                                            <div class="progress"  style="width: 300px">
                                                                <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="<?php echo e($per); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($per); ?>%;"></div>

                                                            </div>
                                                            <span><?php echo e(number_format($per,2)); ?>%</span>    
                                                        </div>                                
                                                ...
                                                <tr>                       
                                                    <td>
                                                        ...
                                                        <?php if(auth()->user()->fidelity_program_reward($item->id)): ?>
...
<?php /**PATH /home/borapedi/public_html/resources/views/restorants/partials/modals.blade.php ENDPATH**/ ?>