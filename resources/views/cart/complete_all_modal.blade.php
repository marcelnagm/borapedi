...
<div class="modal fade" id="modal-order-complete" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5" id="new_address_checkout_body">
                        <div class="tab-content" id="tabs">
                            <div class="tab-pane fade show active" id="passo1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                ...
                                <button class="btn btn-danger right" value="Proximo" onclick="show()">Proximo</button>
                            </div>
                            <div class="tab-pane fade show" id="passo2" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                ...
                                <div class="card-content border-top">
                                    ...
                                    <div class="row" style="margin-bottom:10px;">
                                        <div class="col-12">
                                            <div id="form-group-cep" class="form-group  ">
                                                ...
                                                <input step=".01" type="text" name="Cep" id="cep2" class="form-control form-control cep-form  " placeholder="Coloque seu CEP aqui ..." value="" required="" autofocus="">
                                                <button type="button" style="float:left; " onclick="getAdd2()">
                                    ...
                                    <button class="btn btn-danger left" value="Proximo" onclick="hide()">Voltar</button>
                                </div>
                            </div>                                 
                        </div>
                    </div>
                ...
                <div class="modal-footer">                
                    <button type="button" id="submitNewAddress2" class="btn btn-success">{{ __('Save') }}</button>
                </div>
