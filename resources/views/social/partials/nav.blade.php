        ...
        <div class="navbar-collapse collapse" id="navbar_global">
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <li class="nav-item dropdown show">
                    <a href="#" class="btn btn-neutral btn-icon web-menu" data-toggle="dropdown" role="button" aria-expanded="true">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="/orders" class="dropdown-item">Meus pedidos</a>
                        <a href="/addresses" class="dropdown-item">Meus endereços</a>
